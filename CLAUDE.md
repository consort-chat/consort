...
LiveKit, reading and sending text in a room, attachments, threads, replies
drawn as replies, reactions, mentions, and a typing indicator. Sending an
attachment and editing a message are not built.
